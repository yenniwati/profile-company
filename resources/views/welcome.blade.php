    ...
    <div id="home">
        ...
        <div class="serv_bottom py-sm-5 py-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h4 class="agile-ser_bot text-light text-capitalize">Sed mi tortor, commodo .</h4>
                    ...
                    <div class="col-lg-6 contact-bottom d-flex flex-column contact-right-w3ls">
                        ...
                        <div class="fv3-contact">
                            <div class="row">
                                ...
                                <div class="col-10 contact-add">
                                    <h6>email</h6>
                                    <p>
                                        <a href="mailto:yenniwati8@gmail.com" class="text-dark">YenniWati.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fv3-contact">
                            <div class="row">
                                ...
                                <div class="col-10 contact-add">
                                    <h6>address</h6>
                                    <p>+90 Pauh Padang Sumatera Barat</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="cpy-right text-center py-4">
            <p>© 2019 Precedence. All rights reserved | Design by
